...
date: "`r Sys.Date()`"
params:
  upload_googlesheets: FALSE  # if you want to upload to google, change this option to TRUE or see https://rmarkdown.rstudio.com/lesson-6.html
---

To Run this file, at the R console, **AND upload as a googleSheet**
...
local_filename <- str_remove_all(sheetname, "[^a-z,A-Z,0-9]")
